...
#[test]
fn a_generated_file_is_not_flagged() {
    let p = GitProject::new();
    p.write("base.py", "def entrypoint():\n    return 0\n");
    p.commit_all();
    p.pulse("--cleanup");
    p.write("api_pb2.py", "# Code generated by protoc. DO NOT EDIT.\ndef get_zztop_field():\n    return 1\n");
    let out = p.pulse("--stop");
    assert!(!flags(&out), "generated code is not hand-written agentic bloat: {out}");
}

#[test]
fn an_annotated_override_method_is_not_flagged() {
    let p = GitProject::new();
    p.write("Base.java", "class Base {\n    void existing() {}\n}\n");
    p.commit_all();
    p.pulse("--cleanup");
    p.write(
        "Widget.java",
        "class Widget implements Listener {\n    @Override\n    public void onZztopEvent() {\n    }\n}\n",
    );
    let out = p.pulse("--stop");
