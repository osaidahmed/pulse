...
use pulse::audit::detector_conceptual_cohesion;
use pulse::audit::finding::AuditKind;
use pulse::audit::method_vocab::{method_vocab_from, VocabByMethod};
...
fn scan_repo(repo: &Path, file_cap: usize, audit: &pulse::thresholds::AuditThresholds) -> Vec<(String, f64, u32)> {
