...
use pulse::audit::detector_god_class::build_method_idx_lookup;
...
fn detect_with(defs: Vec<DefinitionRecord>, at: &AuditThresholds) -> Vec<pulse::audit::finding::AuditFinding> {
