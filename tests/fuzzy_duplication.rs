...
fn similar_functions_with_extra_line_detected() {
    ...
    assert!(
        ...
        "similar functions should be detected, got: {}",
        out
    );
    assert!(
        out.contains("similar structure"),
        "should say 'similar structure', got: {}",
        out
    );
}
...
fn exact_clones_say_identical_structure() {
    ...
    assert!(
        out.contains("identical structure"),
        "exact clones should say 'identical structure', got: {}",
        out
    );
}
...
fn similar_functions_with_different_sizes_not_flagged() {
    ...
    assert!(
        !out.contains("similar structure"),
        "very different sizes should not match, got: {}",
        out
    );
}
...
fn similar_functions_in_typescript() {
    ...
    assert!(
        has_smell(&out, "Code Duplication"),
        "should detect similar TS functions, got: {}",
        out
    );
}
...
fn similar_functions_in_rust() {
    ...
    assert!(
        has_smell(&out, "Code Duplication"),
        "should detect similar Rust functions, got: {}",
        out
    );
}
...
fn similar_functions_in_java() {
    ...
    assert!(
        has_smell(&out, "Code Duplication"),
        "should detect similar Java functions, got: {}",
        out
    );
}
...
fn similar_functions_in_c() {
    ...
    assert!(
        has_smell(&out, "Code Duplication"),
        "should detect similar C functions, got: {}",
        out
    );
}
...
fn test_function_exact_duplication_suppressed() {
    ...
    assert!(
        !has_smell(&out, "Code Duplication"),
        "test function duplication should be suppressed, got: {}",
        out
    );
}
...
fn mixed_test_and_prod_duplication_still_flagged() {
    ...
    assert!(
        has_smell(&out, "Code Duplication"),
        "mixed test+prod duplication should be flagged, got: {}",
        out
    );
}
