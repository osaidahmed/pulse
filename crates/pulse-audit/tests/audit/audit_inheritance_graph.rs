...
use pulse_audit::class_registry::{ClassIndex, ClassRegistry};
use pulse_audit::definitions::DefinitionRecord;
use pulse_audit::inheritance::{ancestors_of, build_inheritance_graph, descendants_of};
...
fn build(defs: Vec<DefinitionRecord>) -> (ClassRegistry, pulse_audit::inheritance::InheritanceGraph) {
