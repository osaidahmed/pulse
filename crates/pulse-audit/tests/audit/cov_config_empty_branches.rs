...
use pulse_audit::finding::{AuditFinding, AuditKind, PatternCategory};
use pulse_audit::output::format_findings_filtered;
use pulse_audit::suppression::AuditSuppression;
use pulse_config::{AuditConfig, IgnoreMatcher};
...
fn pattern_finding(snippet: &str) -> AuditFinding {
    AuditFinding {
        ...
        p_value: None,
        locations: vec![pulse_audit::finding::AuditLocation { file: PathBuf::from("a.py"), line: 1 }],
    }
}
