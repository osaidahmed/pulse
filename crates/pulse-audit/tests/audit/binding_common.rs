...
use pulse_audit::binding::BindingTable;
use pulse_audit::call_graph::{CallGraph, MethodIdentity, MethodIndex};
use pulse_audit::call_walker::{calls_and_bindings_from, LocatedCall};
use pulse_audit::corpus::{Corpus, CorpusFile};
use pulse_audit::definitions::{definitions_from, DefinitionRecord};
...
pub fn method_env<'a>(
    out: &'a pulse_audit::call_walker::CallWalkOut,
    name: &str,
) -> Option<&'a pulse_audit::binding::TypeEnv> {
...
pub fn class_binding<'a>(
    out: &'a pulse_audit::call_walker::CallWalkOut,
    name: &str,
) -> Option<&'a pulse_audit::binding::ClassBinding> {
